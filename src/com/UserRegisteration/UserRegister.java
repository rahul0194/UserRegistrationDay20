...
public class UserRegister {
    ...
    public static final String LAST_NAME = "^[A-Z][a-z]*$";
    public static final String EMAIL = "^[a-z.+_-]+[.a-z0-9]*+@[a-z0-9]+[.a-z]+[.a-z0-9]*$";
    public static final String PHONE_NUMBER = "^[+][0-9]{2}[-][0-9]{10}";
    public static final String PASSWORD = "(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*()_-])[a-zA-Z0-9].{8,}$";
